    ...
    <animated.div style={navSpring}>
      ...
      <div className="h-screen w-screen relative">
        ...
        <div className="hidden lg:block">
          <div className="blob top-[4.37%] right-[20.83%] w-[17.40%] max-w-[306px]">
          ...
          <div className="blob bottom-[34.64%] left-[5.02%] w-[22.75%] max-w-[400px]">
          ...
          <div className="blob bottom-[2.2%] left-[14.47%] w-[20.34%] max-w-[360px]">
          ...
          <div className="blob top-[25.07%] right-[3.07%] w-[23.44%] max-w-[412px]">
